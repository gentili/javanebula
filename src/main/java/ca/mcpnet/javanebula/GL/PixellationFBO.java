...
import ca.mcpnet.javanebula.ShaderProgramManager;
import ca.mcpnet.javanebula.jme.BufferUtils;
import ca.mcpnet.javanebula.jme.VertexBuffer;
...
public class PixellationFBO {
	...
	public void end() {
		...
		GL30.glBlitFramebuffer(0, 0, Display.getWidth()/FACTOR, Display.getHeight()/FACTOR, 
